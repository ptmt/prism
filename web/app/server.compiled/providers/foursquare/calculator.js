...
var ExperienceConstants = require('../../models/constants');
    ...
    function FoursquareCalculator() {"use strict";
    ...
    FoursquareCalculator.prototype.startRoutines=function()       {"use strict";
      this.initFunctions.push(function(stats, checkinsData)  {
        stats.fs = stats.fs || {};
        stats.fs.i = 0;
    ...
    FoursquareCalculator.prototype.inProcessRoutines=function()       {"use strict";
    ...
    FoursquareCalculator.prototype.addExperienceAccumulationTasks=function()      
    {"use strict";
      var skill = {
        Sociality: 'sociality',
        Curiosity: 'curiosity'
      }
      this.calculationFunctions.push(function(currentCheckin, stats, p) 
      {
