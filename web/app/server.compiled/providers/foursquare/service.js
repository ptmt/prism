...
var Promise = require('bluebird');
  ...
  function FoursquareService(options)       {"use strict";
  ...
  FoursquareService.prototype.getFoursquareUrl=function(){"use strict";
    return this.foursquareApi.getAuthClientRedirectUrl();
  };

  FoursquareService.prototype.auth=function(code)      {"use strict";
  ...
  FoursquareService.prototype.getCheckins=function(offset        , limit        , callback)                                         {"use strict";
    offset = offset || 0;
    limit = limit || 250;
  ...
  FoursquareService.prototype.getCheckinsWrapper=function(i, allCheckins, cb) {"use strict";
  ...
  FoursquareService.prototype.fetchAllData=function() {"use strict";
    return new Promise(function(resolve, reject)  {
